...
const data = [
    {
        id: 1,
        title: "Introduction",
        description: "Get an overview of the Test Management and learn how to set up Testsigma's Test Management.",
        path: "/docs/test-management/introduction/overview/",
    },
    {
        id: 2,
        title: "Projects",
        description: "Organize and manage your test cases, plans, and runs under individual projects for better traceability.",
        path: "/docs/test-management/projects/manage-projects/",
    },
    {
        id: 3,
        title: "Test Cases",
        description: "Create, edit, and manage test cases to validate application's functionality.",
        path: "/docs/test-management/test-cases/manage-test-cases/",
    },
    {
        id: 4,
        title: "Imports and Exports",
        description: "Import test assets from external tools or export data for reporting, backups, or migration.",
        path: "/docs/test-management/imports-and-exports/csv-file/",
    },
    {
        id: 5,
        title: "Step Groups",
        description: "Build reusable sets of steps to streamline test case creation and reduce redundancy.",
        path: "/docs/test-management/step-groups/create-step-groups/",
    },
    {
        id: 6,
        title: "Test Runs",
        description: "A Test Run is an execution of a group of test cases. Learn how to create and manage Test Runs.",
        path: "/docs/test-management/test-runs/create-test-runs/",
    },
    {
        id: 7,
        title: "Test Plans",
        description: "A Test Plan is a higher-level collection of multiple Test Runs. Create, edit, and manage Test Plans.",
    ...
    },
    {
        id: 9,
        title: "Integrations",
        description: "Integrate Testsigma Test Management with your CI/CD tool for continuous testing.",
        path: "/docs/test-management/integrations/jira/",
    },
    {
        id: 10,
        title: "Account Settings",
        description: "Manage the foundation of your testing properties & environments.",
    ...
    },
    {
        ...
        description: "Leverage intelligent automation powered by Atto to generate, optimize, and execute tests with minimal manual input.",
