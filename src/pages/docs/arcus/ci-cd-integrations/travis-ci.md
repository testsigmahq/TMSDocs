---
title: 'Travis CI Integration with Arcus by Testsigma'
page_title: 'Travis CI Integration with Arcus by Testsigma'
...
noindex: false
order: 17.4
page_id: 'travis-integration-with-arcus-by-testsigma'
warning: false
contextual_links:
  - type: section
    name: 'Contents'
...
**Integrate Travis CI with Arcus by Testsigma and automate your test runs and generate test reports.**

---

Integrate Travis CI with Arcus by Testsigma to automate test executions and generate test reports through CI/CD pipelines. This article discusses integrating Travis CI with Arcus by Testsigma.
