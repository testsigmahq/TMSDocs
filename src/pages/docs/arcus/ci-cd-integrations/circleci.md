---
title: 'CircleCI Integration with Arcus by Testsigma'
page_title: 'CircleCI Integration with Arcus by Testsigma'
...
noindex: false
order: 17.5
page_id: 'circle-ci-integration-with-arcus-by-testsigma'
warning: false
contextual_links:
  - type: section
    name: 'Contents'
...
**Integrate CircleCI with Arcus by Testsigma and automate your test runs and generate test reports.**

---

Integrate CircleCI with Arcus by Testsigma to automate test executions and generate test reports through CI/CD pipelines. This article discusses integrating CircleCI with Arcus by Testsigma.
