---
title: 'GitHub Integration with Arcus by Testsigma'
page_title: 'GitHub Integration with Arcus by Testsigma'
...
noindex: false
order: 17.3
page_id: 'github-integration-with-arcus-by-testsigma'
warning: false
contextual_links:
  - type: section
    name: 'Contents'
...
**Integrate GitHub with Arcus by Testsigma and automate your test runs and generate test reports.**

---

Integrate GitHub with Arcus by Testsigma to automate test executions and generate test reports through CI/CD pipelines. This article discusses integrating GitHub with Arcus by Testsigma.
