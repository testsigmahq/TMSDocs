...
contextual_links:
  ...
  - type: link
    ...
    url: '#install-from-arcus-by-testsigma'
  - type: link
    name: 'Install from Chrome Web Store'
    url: '#install-from-chrome-web-store'
  - type: link
    name: 'Authorize the Extension'
    url: '#authorize-the-extension'
  - type: link
    name: 'Configure the Extension'
    url: '#configure-the-extension'
  - type: link
    name: 'Configure Keyboard Shortcuts'
    url: '#configure-keyboard-shortcuts'
  - type: link
    name: 'Reset Extension Settings (Optional)'
    url: '#reset-extension-settings-optional'
---
