...
metadesc: 'Attach context sources such as Jira, Confluence, Figma, files, and video recordings so the Generator Agent creates test cases that accurately reflect your feature.'
description: 'Learn how to attach context sources in the Playground before generating test cases with the Generator Agent.'
noindex: false
order: 13.21
...
**Give the Generator Agent the right context and it creates test cases that accurately reflect your feature.**

---

Context sources are the inputs the Generator Agent reads before generating test cases. The more relevant your context, the more accurate and complete the output. You can attach context from your project management tools, design files, images, videos, and documents, all in the same session.
...
4. In the stories list, select the checkboxes next to the stories you want the Generator Agent to use as context.
...
3. Select the **Pages** you want the Generator Agent to read.
...
With context attached, the next step is to write your prompt. See [Write Effective Prompts](https://testsigma.com/docs/arcus/qi-home/ad-hoc/write-effective-prompts/).
