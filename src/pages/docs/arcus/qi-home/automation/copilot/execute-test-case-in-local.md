...
The Copilot panel opens in a browser on your machine. The execution flow is the same as Cloud. See [Execution Controls in Copilot](https://testsigma.com/docs/arcus/qi-home/automation/copilot/execution-controls-in-copilot/).
...
The completion flow for Local is the same as Cloud. When execution finishes, save your results and end the session. See [Execute Test Case in Cloud](https://testsigma.com/docs/arcus/qi-home/automation/copilot/execute-test-case-in-cloud/) for the save and end steps.
