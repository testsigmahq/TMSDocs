...
metadesc: 'Review the test cases the Generator Agent created, accept the ones that look right, and save them to your library. Learn the review workflow for sprints and Ad-Hoc sessions.'
description: 'Learn how to review, accept or reject, and save Generator Agent test cases to your library.'
noindex: false
order: 13.26
...
**Review the test cases the Generator Agent created, accept the ones that look right, and save them to your library.**

---

After generation completes, the Generator Agent's test cases are in **Pending** status. They are not part of your library yet. Your job is to review them, accept the ones that are accurate and relevant, and save them. Test cases that are not accepted remain as gaps and count against your coverage.
...
[[info | **NOTE**:]]
| The Generator Agent suggests a folder based on the feature taxonomy of your project. You can accept the suggestion or choose a different folder.
...
Your coverage percentage updates in real time as you accept test cases. See [Coverage and Gaps](https://testsigma.com/docs/arcus/qi-home/coverage-and-gaps/) for how coverage is calculated.
