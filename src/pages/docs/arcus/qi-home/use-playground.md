...
metadesc: 'Open the Playground to add context, generate more test cases, and refine what the Generator Agent produced for any sprint or Ad-Hoc session.'
description: 'Learn how to use the Playground to add context, generate more test cases, and refine Generator Agent output.'
noindex: false
order: 13.25
...
**Open the Playground to add context, generate more test cases, and refine what the Generator Agent produced.**

---

The Playground is the interactive workspace where you work with the Generator Agent after the initial test case generation. Use it to add context you missed the first time, describe specific flows you want the Generator Agent to cover, fill scenario outlines that are still empty, or trigger an additional round of generation for the same sprint or session.
...
For details on each source type, see [Attach Context Sources](https://testsigma.com/docs/arcus/qi-home/ad-hoc/attach-context-sources/).

---

## **Generate More Test Cases**

1. Follow the same steps mentioned in the above section, and in the prompt input area, describe the feature or flow you want the Generator Agent to cover.

2. Click **Generate with AI**. The Generator Agent creates additional test cases and adds them to the current session.
...
For the full review workflow, including saving test cases to your library, see [Review and Accept Test Cases](https://testsigma.com/docs/arcus/qi-home/review-and-accept-test-cases/).
