...
contextual_links:
  ...
  - type: link
    ...
    url: '#prerequisites'
  - type: link
    name: 'Tools Available for Notification Integration'
    url:  '#tools-available-for-notification-integration'
  - type: link
    name: 'Entities Available for Notifications'
    url:  '#entities-available-for-notifications'
---
