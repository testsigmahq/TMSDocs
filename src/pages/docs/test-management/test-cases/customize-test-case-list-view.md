...
page_title: "Customize Test Case List View in Testsigma Test Management"
metadesc: "This article discusses customizing Test Case List View in Testsigma Test Management | Customizing test case list view helps show only the columns that are relevant"
noindex: false
order: 3.5
...
The customize test case list view feature in Testsigma Test Management lets you select the columns that matter most to you. This helps you focus on the specific data you need, beyond the default view. This article discusses steps to customize the test case list view. 
