...
metadesc: 'Write your prompt, click Generate with AI, and Atto builds your test cases. Learn how to trigger Ad-Hoc generation and read the generation summary.'
description: 'Learn how to trigger test case generation in Ad-Hoc and what Atto does during the process.'
noindex: false
order: 13.23
...
This article covers how to trigger test case generation in Ad-Hoc and what Atto does during the process. Before generating, make sure you have attached your context sources and written your prompt. See [Attach Context Sources](https://testsigma.com/docs/test-management/qi-home/ad-hoc/attach-context-sources/) and [Write Effective Prompts](https://testsigma.com/docs/test-management/qi-home/ad-hoc/write-effective-prompts/).
...
> - The Playground is open from **QI Home > Adhoc**. See [Attach Context Sources](https://testsigma.com/docs/test-management/qi-home/ad-hoc/attach-context-sources/) and [Write Effective Prompts](https://testsigma.com/docs/test-management/qi-home/ad-hoc/write-effective-prompts/) if you have not done this yet.
...
[[info | **NOTE**:]]
| Remaining Scenario Outlines are not test cases yet. They are placeholders Atto created to flag areas that need coverage. See [Use Playground](https://testsigma.com/docs/test-management/qi-home/use-playground/) to generate full test cases from them.
