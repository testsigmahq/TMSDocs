...
metadesc: 'The quality of your prompt determines the quality of Atto output. Learn how to write clear, specific prompts that generate accurate, relevant test cases.'
description: 'Learn how to write effective prompts that generate accurate test cases with Atto.'
noindex: false
order: 13.22
...
**The quality of your prompt determines the quality of Atto's output.**

---

Prompts are how you tell Atto what to test. A well-written prompt gives Atto the goal, the context, and the constraints it needs to generate test cases that are accurate and relevant. Vague prompts produce generic test cases. Specific prompts produce test cases that match your feature.
...
> - The Playground is open with context attached. See [Attach Context Sources](https://testsigma.com/docs/test-management/qi-home/ad-hoc/attach-context-sources/) if you have not done this yet.
...
- **Goal**: Have you stated what you want Atto to generate?
...
- **Use personas.** "As a mobile user on a slow connection…" gives Atto relevant constraints that affect test design.
...
When your prompt is ready, see [Generate Test Cases](https://testsigma.com/docs/test-management/qi-home/ad-hoc/generate-test-cases/).
