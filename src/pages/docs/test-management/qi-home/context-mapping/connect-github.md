...
[[info | **NOTE**:]]
| If a PR does not contain a Jira ticket ID, it lands in Unmapped Context regardless of whether Jira is connected. QA maps it manually from there. See [Map GitHub Context](https://testsigma.com/docs/test-management/qi-home/context-mapping/map-github/).
