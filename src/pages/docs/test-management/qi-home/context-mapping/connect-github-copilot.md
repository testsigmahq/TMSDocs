...
* **Context still unmapped**: Atto converts it into a GitHub context. The GitHub Copilot context and the pull request are unified as a single entry in Unmapped Context.
