...
See [Coverage and Gaps](https://testsigma.com/docs/test-management/qi-home/coverage-and-gaps/) for the module-level breakdown.
...
[[info | **NOTE**:]]
| Confidence depends on the nested test plan hierarchy. See [Test Plans](https://testsigma.com/docs/test-management/qi-home/test-plans/) for how the topmost generated and topmost executed plan affect this calculation.
